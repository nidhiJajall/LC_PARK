...
from .views import LCOCRView, LCRequestListCreateView, LCRequestDetailView, LCSAPPayloadPreviewView, LcSapLogListView
...
urlpatterns = [
    ...
    path('<int:pk>/sap_logs/', LcSapLogListView.as_view(), name='lc-sap-logs'),
]
