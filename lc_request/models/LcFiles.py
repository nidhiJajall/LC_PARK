...
class LcFiles(BaseModel):
    ...
    def save(self, *args, **kwargs):
        ...
        # FileField; calling it again here would double the path.  We only need
        # the path string to pass to S3 — derive it from the FileField name if
        # the file has already been assigned, otherwise generate it once.
        ...
        try:
            ...
            fs = FileSystemStorage(
                location=os.path.join(settings.MEDIA_ROOT, file_location)
            )
